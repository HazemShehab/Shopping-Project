...
const submitEditHandler = (event: FormEvent<HTMLFormElement>): void => {
  ...
  <div className="flex flex-col" key={input.id}>
    <label htmlFor={input.id} className="mb-[2px] text-sm font-medium text-white">{input.label}</label>
  ...
  const renderProductEditWithErrorMsg = (id:string, label:string, name: ProductNameTypes) => {
    ...
    <div className="flex flex-col">
      <label htmlFor={id} className="mb-[2px] text-sm font-medium text-white">
        {label}
      </label>
